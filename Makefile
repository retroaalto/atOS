...
RTOSKRNL_INCLUDES ?= \
	...
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/VIDEO/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/DISK/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PS2/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PS2/KEYBOARD/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PIT/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/CPU/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/CPU/GDT/ \
	-I$(SOURCE_KERNEL_DIR)/32RTOSKRNL/CPU/IDT/ \
...
RTOSKRNLCompArgs ?= $(CompArgs) $(RTOSKRNL_INCLUDES) -DRTOS_KERNEL
...
# Link all object files into KRNL.BIN
	...
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PS2/PS2.c -o $(OUTPUT_KERNEL_DIR)/PS2.o
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PS2/KEYBOARD/PS2_KEYBOARD.c -o $(OUTPUT_KERNEL_DIR)/PS2_KEYBOARD.o
	...
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/RTOSKRNL/ISR_IRQ_REDEF.c -o $(OUTPUT_KERNEL_DIR)/ISR_IRQ_REDEF.o
	...
	$(CComp) -m32 -nostdlib -ffreestanding \
		...
		$(OUTPUT_KERNEL_DIR)/VESA.o \
		$(OUTPUT_KERNEL_DIR)/VBE.o \
		$(OUTPUT_KERNEL_DIR)/PS2.o \
		$(OUTPUT_KERNEL_DIR)/PS2_KEYBOARD.o \
		$(OUTPUT_KERNEL_DIR)/ISR.o \
		$(OUTPUT_KERNEL_DIR)/IRQ.o \
		$(OUTPUT_KERNEL_DIR)/ISR_IRQ_REDEF.o \
		$(OUTPUT_KERNEL_DIR)/PIC.o \
		$(OUTPUT_KERNEL_DIR)/PIT.o \
