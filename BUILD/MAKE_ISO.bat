...
mkdir %INPUT_ISO_DIR%\INNER\INNER2
COPY /Y %SOURCE_DIR%\INSIDE_1.txt %INPUT_ISO_DIR%\INNER\INSIDE_1.txt
COPY /Y %SOURCE_DIR%\INSIDE_1.txt %INPUT_ISO_DIR%\INNER\INNER2\INSIDE_1.txt
